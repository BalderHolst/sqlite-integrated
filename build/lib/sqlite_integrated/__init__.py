...
class Database:
    ...
    def raw_entry_to_entry(self, raw_entry: tuple, table: str, id_field, fields=None):
        ...
        return(DatabaseEntry(entry, table, id_field=id_field))


    def get_table(self, name: str, get_only=None, id_field=None):
...
if __name__ == "__main__":
    ...
    print(db.table_overview("artists", max_len=10))
    entry = db.get_entry_by_id("artists", 2, id_field="id")

    entry['Name'] = "Balder"
    
    db.update_table_entry(entry)
